const uk = {
  ...
  home: {
    ...
    track: 'Трекінг',
    service: 'Сервіс',
    stopService: 'Вимкнути',
    searchVehicles: 'Пошук за назвою, номером або VIN…',
    noVehiclesFound: 'Жодного ТЗ не знайдено.',
    enterEditMode: 'Редагування',
    exitEditMode: 'Перегляд',
  },
  profile: {
    title: 'Профіль',
    noData: 'Дані користувача Telegram недоступні. Відкрийте застосунок у Telegram, щоб побачити профіль.',
