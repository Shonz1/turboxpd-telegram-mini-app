const ru = {
  ...
  home: {
    ...
    track: 'Трекинг',
    service: 'Сервис',
    stopService: 'Отключить',
    searchVehicles: 'Поиск по названию, номеру или VIN…',
    noVehiclesFound: 'Транспортные средства не найдены.',
    enterEditMode: 'Редактирование',
    exitEditMode: 'Просмотр',
  },
  profile: {
    title: 'Профиль',
    noData: 'Данные пользователя Telegram недоступны. Откройте приложение внутри Telegram, чтобы увидеть профиль.',
